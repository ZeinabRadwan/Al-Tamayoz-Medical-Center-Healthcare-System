...
use App\Models\LivingTask;
use App\Models\Patients;
use App\Models\ReportTemplate;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Log;

class EverydayLivingTasksController extends Controller
{
    public function create($patient_id, $template_id)
    {
        ...
        return view('everyday_living_tasks.create', compact('patient', 'template'));
    }
...
public function store(Request $request)
{
    ...
    {
        $report = LivingTask::findOrFail($patient_id);
        return view('everyday_living_tasks.show', compact('report'));
    }

    public function edit($id)
    {
        $report = LivingTask::findOrFail($id);
        return view('everyday_living_tasks.edit', compact('report'));
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return redirect()->route('everyday_living_tasks.show', $report->id)->with('success', 'Report updated successfully!');
        } catch (\Exception $e) {
