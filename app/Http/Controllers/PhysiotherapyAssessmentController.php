...
class PhysiotherapyAssessmentController extends Controller
{
    public function create($patient_id, $template_id)
    {
        ...
        return view('physiotherapy_assessment.create', compact('patient', 'template'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            $assessment = PAssessment::create($assessmentData);
            // $assessment->save();
            return redirect()
                ->route('physiotherapy_assessment.show', $assessment->id);
        } catch (\Exception $e) {
    ...
    {
        $report = PAssessment::findOrFail($patient_id);
        return view('physiotherapy_assessment.show', compact('report'));
    }

    public function edit($id)
    {
        $report = PAssessment::findOrFail($id);
        return view('physiotherapy_assessment.edit', compact('report'));
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return redirect()->route('physiotherapy_assessment.show', $report->id)->with('success', 'Report updated successfully!');
        } catch (\Exception $e) {
