...
<form action=" {{ route('adults_physiotherapy_assessment.store') }} " method="Post">
    @csrf
                ...
                <table>
                    <tr>
                        ...
                        <td align=center style='border-left: 1px solid black;'>
                            ...
                            <input class="keda" type="checkbox" id='single' value="1" name='civil_status_single'>
                        </td>
                        <td align=center style='border-left: 1px solid black;'>
                            Married
                            <input class="keda" type="checkbox" id='married' value="1" name='civil_status_married'>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type='text' id='history_of_trauma_illness_date' value=''
                                name='history_of_trauma_illness_date'>
                        </td>
                    </tr>
                    <tr>
                        <th>3.</th>
            ...
            <div class="border size-fit p-fit">
                <div style="margin-right: 2rem; margin-top: 1rem;">
                    ...
                    <h5>
                        ...
                        anomalies, edema, shoulder subluxatio
                    </h5>
                </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <th class="t-center" colspan="2">Date Assessment <input
                                        style="border: 1px solid rgb(10, 226, 10); width: 55%;" type="text" value=""
                                        name="lower_limb_date_assessment">
                                </th>
                                <th class="t-center" colspan="2">Date Follow up <input
                                        style="border: 1px solid rgb(10, 226, 10); width: 55%;" type="text" value=""
                                        name="lower_limb_date_follow_up">
                                </th>
                            </tr>
                            <tr>
                                <th>L</th>
                            ...
                            <tr>
                                ...
                                <td><input style="width: 50px;" type="text" value=""
                                        name="shoulder_medial_rotation_l_1"></td>
                                <td><input style="width: 50px;" type="text" value=""
                                        name="shoulder_medial_rotation_r_1"></td>
                                <td><input style="width: 50px;" type="text" value=""
                                        name="shoulder_medial_rotation_l_2"></td>
                                <td><input style="width: 50px;" type="text" value=""
                                        name="shoulder_medial_rotation_r_2"></td>
                            </tr>
                            <tr>
                                <td style="font-size: 10px;">Lateral Rotation 80</td>
                                <td><input style="width: 50px;" type="text" value=""
                                        name="shoulder_lateral_rotation_l_1"></td>
                                <td><input style="width: 50px;" type="text" value=""
                                        name="shoulder_lateral_rotation_r_1"></td>
                                <td><input style="width: 50px;" type="text" value=""
                                        name="shoulder_lateral_rotation_l_2"></td>
                                <td><input style="width: 50px;" type="text" value=""
                                        name="shoulder_lateral_rotation_r_2"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input style="width: 50px;" type="text" value="" name="finger_thumb_opposition_l_1">
                                </td>
                                <td><input style="width: 50px;" type="text" value="" name="finger_thumb_opposition_r_1">
                                </td>
                                <td><input style="width: 50px;" type="text" value="" name="finger_thumb_opposition_l_2">
                                </td>
                                <td><input style="width: 50px;" type="text" value="" name="finger_thumb_opposition_r_2">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input style="width: 50px;" type="text" value="" name="finger_mp_extension_l_1">
                                </td>
                                <td><input style="width: 50px;" type="text" value="" name="finger_mp_extension_r_1">
                                </td>
                                <td><input style="width: 50px;" type="text" value="" name="finger_mp_extension_l_2">
                                </td>
                                <td><input style="width: 50px;" type="text" value="" name="finger_mp_extension_r_2">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tbody>
                                <tr style="height: 60px; width: 100%;">
                                    ...
                                    <th rowspan="1" class="t-center" colspan="4">RT<input
                                            style="border: 1px solid rgb(10, 226, 10); width: 100%;" type="text"
                                            value="" name="lower_limb_rt">
                                    </th>
                                ...
                                <table style="width: 100%; font-size: 12px;" class="RangeOfMotionTable" border="1">
                                    <tbody class="mb-4">
                                        <tr style="height: 60px; width: 100%;">
                                            ...
                                            <th rowspan="1" class="t-center" colspan="4">RT<input
                                                    style="border: 1px solid rgb(10, 226, 10); width: 100%;" type="text"
                                                    value="" name="upper_limb_rt">
                                            </th>
                                            <th rowspan="1" class="t-center" colspan="4">LT <input
                                                    style="border: 1px solid rgb(10, 226, 10); width: 100%;" type="text"
                                                    value="" name="upper_limb_lt">
                                            </th>
                                        </tr>
                                    </tbody>
                                </table>
                        ...
                        <table class="RangeOfMotionTable" border="1">
                            <tbody>
                                <tr>
                                    ...
                                    <th class="t-center"><input class="keda" type="checkbox" value="1"
                                            name="static_sitting_normal"> Normal</th>
                                </tr>
                                <tr>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1"
                                            name="static_sitting_good"> Good</th>
                                </tr>
                                <tr>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1"
                                            name="static_sitting_poor"> Poor</th>
                                </tr>
                                <tr>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1"
                                            name="static_sitting_not_possible"> Not Possible</th>
                                </tr>
                                <tr>
                                    <th class="t-center" rowspan="4">Standing Static</th>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1"
                                            name="static_standing_normal"> Normal</th>
                                </tr>
                                <tr>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1"
                                            name="static_standing_good"> Good</th>
                                </tr>
                                <tr>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1"
                                            name="static_standing_poor"> Poor</th>
                                </tr>
                                <tr>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1"
                                            name="sstatic_tanding_not_possible"> Not Possible</th>
                                </tr>

                                <tr>
                                    <th class="t-center" rowspan="4">Dynamic Static</th>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1"
                                            name="dynamic_sitting_normal"> Normal</th>
                                </tr>
                                <tr>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1"
                                            name="dynamic_sitting_good"> Good</th>
                                </tr>
                                <tr>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1"
                                            name="dynamic_sitting_poor"> Poor</th>
                                </tr>
                                <tr>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1"
                                            name="dynamic_sitting_not_possible"> Not Possible</th>
                                </tr>
                                <tr>
                                    <th class="t-center" rowspan="4">Dynamic Static</th>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1"
                                            name="dynamic_standing_normal"> Normal</th>
                                </tr>
                                <tr>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1"
                                            name="dynamic_standing_good"> Good</th>
                                </tr>
                                <tr>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1"
                                            name="dynamic_standing_poor"> Poor</th>
                                </tr>
                                <tr>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1"
                                            name="dynamic_standing_not_possible"> Not Possible</th>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <table class="RangeOfMotionTable" border="1">
                            <tbody>
                                <tr>
                                    ...
                                    <th colspan="2" class="t-center"><input class="keda" type="checkbox" value="1"
                                            name="upper_limbs_good"> Good</th>
                                    <th colspan="2" class="t-center"><input class="keda" type="checkbox" value="1"
                                            name="upper_limbs_poor"> Poor</th>
                                    <th colspan="2" class="t-center"><input class="keda" type="checkbox" value="1"
                                            name="upper_limbs_not_possible"> Not Possible</th>
                                </tr>
                                <tr>
                                    <th>L</th>
                                    <th>R</th>
                                ...
                                <tr>
                                    ...
                                    <th colspan="2" class="t-center"><input class="keda" type="checkbox" value="1"
                                            name="lower_limbs_good"> Good</th>
                                    <th colspan="2" class="t-center"><input class="keda" type="checkbox" value="1"
                                            name="lower_limbs_poor"> Poor</th>
                                    <th colspan="2" class="t-center"><input class="keda" type="checkbox" value="1"
                                            name="lower_limbs_not_possible"> Not Possible</th>
                                </tr>
                                <tr>
                                    <th>L</th>
                                    <th>R</th>
                                ...
                                <tr>
                                    ...
                                    <td colspan="6">
                                        <textarea value='' name="coordination_comments" cols="30"
                                            rows="3">   </textarea>
                                    </td>
                                </tr>
                            </tbody>
