...
<div class="container py-5">
    ...
    <form method="POST" action="{{ url('appointments/store') }}" id="appointment-form"
        ...
        <div class="form-step" id="step-4" style="display: none;">
            <!-- Message box to display validation messages -->
            <div id="validation-message" class="alert alert-danger" style="display: none; margin-top: 20px;">
                فقط يُسمح للذكور حتى سن 15 عامًا وللإناث.
            </div>
            <div class="mb-4">
            ...
            <div id="new_patient_fields" style="display: none;">
                ...
                <div class="mb-3">
                    <label for="gender" class="form-label fw-bold text-success">الجنس</label>
                    <select id="gender" name="gender" class="form-select border-success" required>
...
<!-- Patient Summary Section (initially hidden) -->
...
function updateSummary(currentStep) {
    ...
    function validatePatientSubmission() {
    ...
    document.getElementById('gender').addEventListener('change', validatePatientSubmission);
    document.getElementById('dob').addEventListener('change', validatePatientSubmission);
</script>
