...
<form action="{{ route('dysfluency_sheet.store') }}" method="Post">
    @csrf
        ...
        <div style="min-width: 820px; max-width: 1060px;font-size: 14px;" class="border Subjective_Assessment_con">
            ...
            <div class="row" style="gap: .3rem;margin-left: 2rem;">
                <div class="flex">
                    ...
                    <span>Age:</span>&nbsp;
                    <input style="width: 30px;" type="number" value="" name="age">&nbsp;&nbsp;
                    <span>Sex:</span>&nbsp;
                    <input style="width: 60px;" type="text" value="" name="sex">&nbsp;&nbsp;
                    <span>Residence:</span>&nbsp;
                ...
                <div class="flex">
                    ...
                    <input type="text" value="" name="parent_age">&nbsp;&nbsp;
                    <span>Job:</span>&nbsp;
                ...
                <div class="flex" style="justify-content: space-between;">
                    <div>
                        ...
                        <input type="text" value="" name="socioeconomic_status">&nbsp;&nbsp;
                    </div>
                    <div>
                        <span>Home occupancy:</span>&nbsp;
                        <input type="text" value="" name="home_occupancy">
                    </div>
                </div>
                <div class="flex" style="justify-content: space-between;">
                    <div>
                        <span>Handedness:</span>&nbsp;
                        <input type="text" value="" name="handedness">&nbsp;&nbsp;
                    </div>
                    <div>
                        <span>Bilingualism:</span>&nbsp;
                        <input type="text" value="" name="bilingualism">
                    </div>
                </div>
                <div class="flex" style="justify-content: space-between;">
                    <div>
                ...
                <div class="flex" style="justify-content: space-between;">
                    <div>
                        ...
                        <input type="text" value="" name="motor_skill">&nbsp;&nbsp;
                    </div>
                    <div>
                        <span>Hearing Subjectively:</span>&nbsp;
                        <input type="text" value="" name="hearing_subjectively">
                    </div>
                </div>
                <div>
                    <div>
                        <span>Similar conditions in the family:</span>&nbsp;
                        <input style="width: 70%;" type="text" value="" name="similar_conditions_in_family">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div>
                    <span>Duration:</span>&nbsp;
                    <input style="width: 70%;" type="text" value="" name="duration">
                </div>
                <div>
                    Onset:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    gradual&nbsp;
                ...
                <div>
                    ...
                    Intermittent&nbsp;
                    <input type="checkbox" value="1" name="course_intermittent">
                </div>
                ...
                <div class="row" style="margin-left: 2rem;gap: .3rem;">
                    <div class="flex">
                        ...
                        <input class="w-full" type="text" value="" name="patients_severity_rating">
                    </div>
                    <div class="flex">
                        <span class="flex"><span>Listener’s</span>&nbsp;<span>&nbsp;</span><span>reaction:</span></span>&nbsp;
                        <input class="w-full" type="text" value="" name="listeners_reaction">
                    </div>
                    <span>Effect on personal, social, heterosexual, home, school, vocational, behavior</span> <br>
                    <textarea class="w-full" name="effect_on_personal_social_behavior"></textarea>
                </div>
                ...
                <div class="row" style="margin-left: 10rem;gap: .3rem;">
                    <div class="flex" style="justify-content: space-between;">
                        <div>
                            <span>Fits:</span>&nbsp;
                            <input type="text" value="" name="fits">&nbsp;&nbsp;
                        </div>
                        <div>
                            <span>Drugs:</span>&nbsp;
                            <input type="text" value="" name="drugs">
                        </div>
                    </div>
                    <div class="flex" style="justify-content: space-between;">
                        <div>
                            <span>History of DLD:</span>&nbsp;
                            <input type="text" value="" name="history_of_dld">&nbsp;&nbsp;
                        </div>
                        <div>
                            <span>Earlier intervention:</span>&nbsp;
                            <input type="text" value="" name="earlier_intervention">
                        </div>
                    </div>
                </div>
                ...
                <div class="row" style="margin-left: 2rem;gap: .3rem;">
                    ...
                    <div class="flex">
                        ...
                        <input class="w-full" type="text" value="" name="difficult_phonemes_words">
                    </div>
                    <div class="flex">
        ...
        <div style="min-width: 820px; max-width: 1060px;font-size: 14px;" class="border Subjective_Assessment_con">
            ...
            <div class="row" style="margin-left: 3rem;gap: .3rem;">
                ...
                <div>
                    ...
                    Part Sound&nbsp;
                    <input type="checkbox" value="1" name="intraphonemic_disruption_part_sound">&nbsp;&nbsp;&nbsp;&nbsp;
                    Part syllable&nbsp;
                    <input type="checkbox" value="1" name="intraphonemic_disruption_part_syllable">
                </div>
                <div>
                    Adequate initiation of phonation :&nbsp;&nbsp;
                    <input class="w-half" type="text" value="" name="adequate_phonation">
                </div>
                <label>Secondary Reactions:</label>
                <div>
                    Prolongation&nbsp;
                    <input type="checkbox" value="1" name="secondary_prolongation">&nbsp;&nbsp;&nbsp;&nbsp;
                    Tonic blockage&nbsp;
                    <input type="checkbox" value="1" name="secondary_blockage">
                </div>
                <label>Devices to cancel stuttering:</label>
                <div>
                    Avoidance: <input type="checkbox" value="1" name="stuttering_avoidance">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    Mutism&nbsp;
                    <input type="checkbox" value="1" name="stuttering_mutism">&nbsp;&nbsp;&nbsp;&nbsp;
                    Word substitution&nbsp;
                    <input type="checkbox" value="1" name="stuttering_substitution">&nbsp;&nbsp;&nbsp;&nbsp;
                    Talking&nbsp;
                    <input type="checkbox" value="1" name="stuttering_talking">
                </div>
                <div>
                    <span>Post ponement pausing</span>&nbsp;
                    <input type="text" value="" name="ponement_pausing">&nbsp;&nbsp;&nbsp;
                    Repeating proceeded words&nbsp;
                    <input type="text" value="" name="repeating_proceeded_words">
                </div>
            </div>
        </div>
    </body>
