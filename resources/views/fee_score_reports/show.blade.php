...
<form>
    ...
    <body style="display: flex; flex-direction: column; font-weight: .5rem; align-items: center; gap: 2rem;">
        <div style="min-width: 820px; max-width: 1060px;font-size: 14px;" class="border Subjective_Assessment_con">
            ...
            <ol type="A">
                <li>
                    ...
                    <input readonly type="checkbox" onclick="return False;" name="velopharyngeal_closure_complete" value="1" {{ $report->velopharyngeal_closure_complete ? 'checked' : '' }}>&nbsp;&nbsp;Complete <br>
                    <input type="hidden" name="velopharyngeal_closure_incomplete" value="0">
                    <input readonly type="checkbox" onclick="return False;" name="velopharyngeal_closure_incomplete" value="1" {{ $report->velopharyngeal_closure_incomplete ? 'checked' : '' }}>&nbsp;&nbsp;Incomplete <br>

                </li>
                <li>
                    <u>Anatomy</u><br>
                    <input type="hidden" name="anatomy_normal" value="0">
                    <input readonly type="checkbox" onclick="return False;" name="anatomy_normal" value="1" {{ $report->anatomy_normal ? 'checked' : '' }}>&nbsp;&nbsp;Normal
                    <input readonly style="width: 99%;" type="text" value="{{ $report->anatomy_text}}" name="anatomy_text">
                    <hr style="font-weight: bolder;">
                    <p>
                        <input type="hidden" name="anatomy_pathology" value="0">
                        <input readonly type="checkbox" onclick="return False;" name="anatomy_pathology" value="1" {{ $report->anatomy_pathology ? 'checked' : '' }}>&nbsp;Possible pathology that should be seen by a physician, including suspicious mucosal
                        irregularity, unusual shape of anatomical structure, immobility of vocal folds; narrow
                        airway&nbsp;<input readonly type="text" value="{{ $report->anatomy_pathology_text}}" name="anatomy_pathology_text">
                    </p>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ul style="list-style-type: square;">
                        <li>
                            Respiratory rate:&nbsp;&nbsp;<input readonly style="width: 60%;" type="text" value="{{ $report->respiratory_rate}}" name="respiratory_rate">
                        </li>
                        <li>
                            <input type="hidden" name="laryngeal_movements_normal" value="0">
                            Even, normal movement of vocal folds.&nbsp;&nbsp;<input readonly type="checkbox" onclick="return False;" name="laryngeal_movements_normal" value="1" {{ $report->laryngeal_movements_normal ? 'checked' : '' }}>
                        </li>
                        <li>
                            <input type="hidden" name="laryngeal_movements_labored" value="0">
                            Respiratory rate fast or labored. &nbsp;&nbsp;<input readonly type="checkbox" onclick="return False;" name="laryngeal_movements_labored" value="1" {{ $report->laryngeal_movements_labored ? 'checked' : '' }}>
                        </li>
                    </ul>
                </li>
                <li>
        ...
        <div class='conta'>
            <a href="{{ route('fee_score_reports.edit', $report->id ) }}"
                class="
                    dko">
                تعديل
            </a>
