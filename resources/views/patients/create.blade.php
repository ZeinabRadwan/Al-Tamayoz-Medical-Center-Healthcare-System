...
<div class="container">
    ...
    <form action="{{ route('patients.store') }}" method="POST">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <label for="dob" class="form-label fw-bold">تاريخ الميلاد <span class="text-danger">*</span></label>
...
<div class="col-md-6">
    <label for="how_did_you_find_out_about_us">كيف عرفت علي المجمع؟</label>
    <input type="text" name="how_did_you_find_out_about_us" id="how_did_you_find_out_about_us" class="form-control" value="{{ old('how_did_you_find_out_about_us') }}">
</div>
...
هل يوجد تأمين؟                    </label>
                <div class="d-flex align-items-center">
                    <div class="form-check custom-radio me-3">
                        <input class="form-check-input" type="radio" name="has_insurance" id="insurance_yes" value="yes" onchange="toggleInsuranceField()">
                        <label class="form-check-label" for="insurance_yes">نعم</label>
                    </div>
                    <div class="form-check custom-radio">
                        <input class="form-check-input" type="radio" name="has_insurance" id="insurance_no" value="no" onchange="toggleInsuranceField()">
            ...
            <div class="col-md-6">
                <label for="nationality" class="form-label fw-bold">الجنسية
        ...
        <div class="d-flex justify-content-center mt-4">
            <button type="submit" class="btn px-4 ms-2 me-3">حفظ</button>
            <a id="printButton" class="btn btn-outline-secondary px-4 ms-2 me-3 " onclick="printPage()">طباعة</a>
        </div>
    </form>
