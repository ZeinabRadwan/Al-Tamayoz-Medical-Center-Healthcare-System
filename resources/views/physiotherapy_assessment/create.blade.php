...
<form action=" {{ route('physiotherapy_assessment.store') }} " method="Post">
    @csrf
        ...
        <body style="display: flex; flex-direction: column; gap: 2rem; align-items: center;">
            <div class="border size-fit p-fit">
                ...
                <div style="display: flex; flex-wrap: wrap; gap: 1.5rem; margin-bottom: 1rem;">
                    <div style="flex: 2;">
                        ...
                        <input style="width: 100%; margin-bottom: 0.5rem;" type="text" value='' name="patient_name">
                        <label>Diagnosis:</label>
                        <input style="width: 100%;" type="text" value='' name="diagnosis">
                    </div>
                    <div style="flex: 1;">
                        <label>Nationality:</label>
                        <input style="width: 100%; margin-bottom: 0.5rem;" type="text" value='' name="nationality">
                        <label>Patient Age:</label>
                        <input style="width: 100%;" type="text" value='' name="patient_age">
                    </div>
                    <div style="flex: 2;">
                        <label>Occupation:</label>
                        <input style="width: 100%; margin-bottom: 0.5rem;" type="text" value='' name="occupation">
                        <label>ID/MRN:</label>
                        <input style="width: 100%;" type="text" value='' name="id_mrn">
                    </div>

                    <div style="flex:1 ;">
                        <label>Gender:</label>
                        <input type="checkbox" id="female" value='1' name="gender_female">
                        <label for="female">F</label>
                        <input type="checkbox" id="male" value='1' name="gender_male">
                ...
                <table>
                    <tr>
                        ...
                        <td colspan="2" align=center style='border-left: 1px solid black;'>
                            <textarea name="history_of_trauma_illness" rows="3" style="width: 100%;"></textarea>
                        </td>
                        <td>
                            <label for='history_of_trauma_illness_date'>Date</label>
                            <input type='text' id='history_of_trauma_illness_date' value='' name='history_of_trauma_illness_date'>
                        </td>
                    </tr>
                    <tr>
                        <th>3.</th>
                        ...
                        <td colspan="4" align=center style='border-left: 1px solid black;'>
                            <textarea name="medical_history_chief_complain" rows="3" style="width: 100%;"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <th>4.</th>
                        ...
                        <td colspan="4" align=center style='border-left: 1px solid black;'>
                            <textarea name="xray_other_ex" rows="3" style="width: 100%;"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <th>5.</th>
                        ...
                        <td colspan="4" align=center style='border-left: 1px solid black;'>
                            <textarea name="pain_level_vas" rows="3" style="width: 100%;"></textarea>
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="text" style="width: 95%;" value="" name="swelling_right"></td>
                        <td><input type="text" style="width: 95%;" value="" name="swelling_left"></td>
                    </tr>
                    <tr>
                        <th class="bg-grey">Callus</th>
                        <td><input type="text" style="width: 95%;" value="" name="callus_right"></td>
                        <td><input type="text" style="width: 95%;" value="" name="callus_left"></td>
                    </tr>
                    <tr>
                        <th class="bg-grey">Scar</th>
                        <td><input type="text" style="width: 95%;" value="" name="scar_right"></td>
                        <td><input type="text" style="width: 95%;" value="" name="scar_left"></td>
                    </tr>
                    <tr>
                        <th class="bg-grey">Wound</th>
                        <td><input type="text" style="width: 95%;" value="" name="wound_right"></td>
                        <td><input type="text" style="width: 95%;" value="" name="wound_left"></td>
                    </tr>
                    <tr>
                        <th class="bg-grey">Temperature</th>
                        <td><input type="text" style="width: 95%;" value="" name="temperature_right"></td>
                        <td><input type="text" style="width: 95%;" value="" name="temperature_left"></td>
                    </tr>
                    <tr>
                        <th class="bg-grey">Infection</th>
                        <td><input type="text" style="width: 95%;" value="" name="infection_right"></td>
                        <td><input type="text" style="width: 95%;" value="" name="infection_left"></td>
                    </tr>
                    <tr>
                        <th class="bg-grey">Pain</th>
                        <td><input type="text" style="width: 95%;" value="" name="pain_right"></td>
                        <td><input type="text" style="width: 95%;" value="" name="pain_left"></td>
                    </tr>
                    <tr>
                        <th class="bg-grey">Abnormal Sensation</th>
                        <td><input type="text" style="width: 95%;" value="" name="abnormal_sensation_right"></td>
                        <td><input type="text" style="width: 95%;" value="" name="abnormal_sensation_left"></td>
                    </tr>
                    <tr>
                        <td>Extension 0</td>
                        <td><input style="width:50px;" type="text" value="" name="extension_0_1"></td>
                        <td><input style="width:50px;" type="text" value="" name="extension_0_2"></td>
                        <td><input style="width:50px;" type="text" value="" name="extension_0_3"></td>
                        <td><input style="width:50px;" type="text" value="" name="extension_0_4"></td>
                    </tr>
                    <tr>
                        <td>ANKLE-FOOT</td>
                        <td><input style="width:50px;" type="text" value="" name="ankle_foot_1"></td>
                        <td><input style="width:50px;" type="text" value="" name="ankle_foot_2"></td>
                        <td><input style="width:50px;" type="text" value="" name="ankle_foot_3"></td>
                        <td><input style="width:50px;" type="text" value="" name="ankle_foot_4"></td>
                    </tr>
                    <tr>
                        <td>Dorsi Flexion 30</td>
                        <td><input style="width:50px;" type="text" value="" name="dorsi_flexion_1"></td>
                        <td><input style="width:50px;" type="text" value="" name="dorsi_flexion_2"></td>
                        <td><input style="width:50px;" type="text" value="" name="dorsi_flexion_3"></td>
                        <td><input style="width:50px;" type="text" value="" name="dorsi_flexion_4"></td>
                    </tr>
                    <tr>
                        <td>Plantar Flexion 45</td>
                        <td><input style="width:50px;" type="text" value="" name="plantar_flexion_1"></td>
                        <td><input style="width:50px;" type="text" value="" name="plantar_flexion_2"></td>
                        <td><input style="width:50px;" type="text" value="" name="plantar_flexion_3"></td>
                        <td><input style="width:50px;" type="text" value="" name="plantar_flexion_4"></td>
                    </tr>
                    <tr>
                        <td>Inversion 35</td>
                        <td><input style="width:50px;" type="text" value="" name="inversion_1"></td>
                        <td><input style="width:50px;" type="text" value="" name="inversion_2"></td>
                        <td><input style="width:50px;" type="text" value="" name="inversion_3"></td>
                        <td><input style="width:50px;" type="text" value="" name="inversion_4"></td>
                    </tr>
                    <tr>
                        <td>Eversion 15</td>
                        <td><input style="width:50px;" type="text" value="" name="eversion_1"></td>
                        <td><input style="width:50px;" type="text" value="" name="eversion_2"></td>
                        <td><input style="width:50px;" type="text" value="" name="eversion_3"></td>
                        <td><input style="width:50px;" type="text" value="" name="eversion_4"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Flexion cm</td>
                        <td><input style="width:50px;" type="text" value="" name="neck_flexion_1"></td>
                        <td><input style="width:50px;" type="text" value="" name="neck_flexion_2"></td>
                        <td><input style="width:50px;" type="text" value="" name="neck_flexion_3"></td>
                        <td><input style="width:50px;" type="text" value="" name="neck_flexion_4"></td>
                    </tr>
                    <tr>
                        <td>Extension cm</td>
                        <td><input style="width:50px;" type="text" value="" name="neck_extension_1"></td>
                        <td><input style="width:50px;" type="text" value="" name="neck_extension_2"></td>
                        <td><input style="width:50px;" type="text" value="" name="neck_extension_3"></td>
                        <td><input style="width:50px;" type="text" value="" name="neck_extension_4"></td>
                    </tr>
                    <tr>
                        <td>Latero-Flexion R cm</td>
                        <td><input style="width:50px;" type="text" value="" name="neck_latero_flexion_r_1"></td>
                        <td><input style="width:50px;" type="text" value="" name="neck_latero_flexion_r_2"></td>
                        <td><input style="width:50px;" type="text" value="" name="neck_latero_flexion_r_3"></td>
                        <td><input style="width:50px;" type="text" value="" name="neck_latero_flexion_r_4"></td>
                    </tr>
                    <tr>
                        <td>Latero-Flexion L cm</td>
                        <td><input style="width:50px;" type="text" value="" name="neck_latero_flexion_l_1"></td>
                        <td><input style="width:50px;" type="text" value="" name="neck_latero_flexion_l_2"></td>
                        <td><input style="width:50px;" type="text" value="" name="neck_latero_flexion_l_3"></td>
                        <td><input style="width:50px;" type="text" value="" name="neck_latero_flexion_l_4"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input style="width:50px;" type="text" value="" name="global_flexion_1"></td>
                        <td><input style="width:50px;" type="text" value="" name="global_flexion_2"></td>
                        <td><input style="width:50px;" type="text" value="" name="global_flexion_3"></td>
                        <td><input style="width:50px;" type="text" value="" name="global_flexion_4"></td>
                    </tr>
                    <tr>
                        <td style="font-size: 10px;">Thoracic Flexion (Ott Test) cm</td>
                        <td><input style="width:50px;" type="text" value="" name="thoracic_flexion_1"></td>
                        <td><input style="width:50px;" type="text" value="" name="thoracic_flexion_2"></td>
                        <td><input style="width:50px;" type="text" value="" name="thoracic_flexion_3"></td>
                        <td><input style="width:50px;" type="text" value="" name="thoracic_flexion_4"></td>
                    </tr>
                    <tr>
                        <td style="font-size: 10px;">Lumbar Flexion (Schober test)</td>
                        <td><input style="width:50px;" type="text" value="" name="lumbar_flexion_1"></td>
                        <td><input style="width:50px;" type="text" value="" name="lumbar_flexion_2"></td>
                        <td><input style="width:50px;" type="text" value="" name="lumbar_flexion_3"></td>
                        <td><input style="width:50px;" type="text" value="" name="lumbar_flexion_4"></td>
                    </tr>
                    <tr>
                        <td>Global Extension cm</td>
                        <td><input style="width:50px;" type="text" value="" name="global_extension_1"></td>
                        <td><input style="width:50px;" type="text" value="" name="global_extension_2"></td>
                        <td><input style="width:50px;" type="text" value="" name="global_extension_3"></td>
                        <td><input style="width:50px;" type="text" value="" name="global_extension_4"></td>
                    </tr>
                    <tr>
                        <td>Latero-Flexion R cm</td>
                        <td><input style="width:50px;" type="text" value="" name="latero_flexion_r_1"></td>
                        <td><input style="width:50px;" type="text" value="" name="latero_flexion_r_2"></td>
                        <td><input style="width:50px;" type="text" value="" name="latero_flexion_r_3"></td>
                        <td><input style="width:50px;" type="text" value="" name="latero_flexion_r_4"></td>
                    </tr>
                    <tr>
                        <td>Latero-Flexion L cm</td>
                        <td><input style="width:50px;" type="text" value="" name="latero_flexion_l_1"></td>
                        <td><input style="width:50px;" type="text" value="" name="latero_flexion_l_2"></td>
                        <td><input style="width:50px;" type="text" value="" name="latero_flexion_l_3"></td>
                        <td><input style="width:50px;" type="text" value="" name="latero_flexion_l_4"></td>
                    </tr>
                    <tr>
                        <td style="font-size: 10px;">Rotation R (write OK or imp.)</td>
                        <td><input style="width:50px;" type="text" value="" name="rotation_r_1"></td>
                        <td><input style="width:50px;" type="text" value="" name="rotation_r_2"></td>
                        <td><input style="width:50px;" type="text" value="" name="rotation_r_3"></td>
                        <td><input style="width:50px;" type="text" value="" name="rotation_r_4"></td>
                    </tr>
                    <tr>
                        <td style="font-size: 10px;">Rotation L (write OK or imp.)</td>
                        <td><input style="width: 50px;" type="text" value="" name="rotation_l_1"></td>
                        <td><input style="width: 50px;" type="text" value="" name="rotation_l_2"></td>
                        <td><input style="width: 50px;" type="text" value="" name="rotation_l_3"></td>
                        <td><input style="width: 50px;" type="text" value="" name="rotation_l_4"></td>
                    </tr>
                    </tbody>
                </table>
                <div>
                    <table style="width: 100%; font-size: 12px;" class="RangeOfMotionTable" border="1">
                        <tbody>
                            <tr>
                                <th rowspan="2">LOWER LIMB</th>
                                <th class="t-center" colspan="2">Date Assessment <input
                                        style="border: 1px solid rgb(10, 226, 10); width: 55%;" type="text" value="" name="lower_limb_date_assessment">
                                </th>
                                <th class="t-center" colspan="2">Date Follow up <input
                                        style="border: 1px solid rgb(10, 226, 10); width: 55%;" type="text" value="" name="lower_limb_date_follow_up">
                                </th>
                            </tr>
                            <tr>
                                <th>L</th>
                            ...
                            <tr>
                                <th colspan="5">SHOULDER</th>
                            </tr>
                            <tr>
                                <td style="font-size: 10px;">Extension 60</td>
                                <td><input style="width: 50px;" type="text" value="" name="shoulder_extension_l_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="shoulder_extension_r_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="shoulder_extension_l_2"></td>
                                <td><input style="width: 50px;" type="text" value="" name="shoulder_extension_r_2"></td>
                            </tr>
                            <tr>
                                <td style="font-size: 10px;">Abduction 180</td>
                                <td><input style="width: 50px;" type="text" value="" name="shoulder_abduction_l_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="shoulder_abduction_r_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="shoulder_abduction_l_2"></td>
                                <td><input style="width: 50px;" type="text" value="" name="shoulder_abduction_r_2"></td>
                            </tr>
                            <tr>
                                <td style="font-size: 10px;">Adduction 30</td>
                                <td><input style="width: 50px;" type="text" value="" name="shoulder_adduction_l_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="shoulder_adduction_r_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="shoulder_adduction_l_2"></td>
                                <td><input style="width: 50px;" type="text" value="" name="shoulder_adduction_r_2"></td>
                            </tr>
                            <tr>
                                <td style="font-size: 10px;">Medial Rotation 95</td>
                                <td><input style="width: 50px;" type="text" value="" name="shoulder_medial_rotation_l_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="shoulder_medial_rotation_r_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="shoulder_medial_rotation_l_2"></td>
                                <td><input style="width: 50px;" type="text" value="" name="shoulder_medial_rotation_r_2"></td>
                            </tr>
                            <tr>
                                <td style="font-size: 10px;">Lateral Rotation 80</td>
                                <td><input style="width: 50px;" type="text" value="" name="shoulder_lateral_rotation_l_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="shoulder_lateral_rotation_r_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="shoulder_lateral_rotation_l_2"></td>
                                <td><input style="width: 50px;" type="text" value="" name="shoulder_lateral_rotation_r_2"></td>
                            </tr>
                            <tr>
                                <th colspan="5">ELBOW</th>
                            </tr>
                            <tr>
                                <td style="font-size: 10px;">Flexion 150</td>
                                <td><input style="width: 50px;" type="text" value="" name="elbow_flexion_l_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="elbow_flexion_r_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="elbow_flexion_l_2"></td>
                                <td><input style="width: 50px;" type="text" value="" name="elbow_flexion_r_2"></td>
                            </tr>
                            <tr>
                                <td style="font-size: 10px;">Extension 0</td>
                                <td><input style="width: 50px;" type="text" value="" name="elbow_extension_l_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="elbow_extension_r_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="elbow_extension_l_2"></td>
                                <td><input style="width: 50px;" type="text" value="" name="elbow_extension_r_2"></td>
                            </tr>
                            <tr>
                                <th colspan="5">FOREARM</th>
                            </tr>
                            <tr>
                                <td style="font-size: 10px;">Pronation 80</td>
                                <td><input style="width: 50px;" type="text" value="" name="forearm_pronation_l_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="forearm_pronation_r_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="forearm_pronation_l_2"></td>
                                <td><input style="width: 50px;" type="text" value="" name="forearm_pronation_r_2"></td>
                            </tr>
                            <tr>
                                <td style="font-size: 10px;">Supination 80</td>
                                <td><input style="width: 50px;" type="text" value="" name="forearm_supination_l_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="forearm_supination_r_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="forearm_supination_l_2"></td>
                                <td><input style="width: 50px;" type="text" value="" name="forearm_supination_r_2"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input style="width: 50px;" type="text" value="" name="wrist_flexion_l_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="wrist_flexion_r_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="wrist_flexion_l_2"></td>
                                <td><input style="width: 50px;" type="text" value="" name="wrist_flexion_r_2"></td>
                            </tr>
                            <tr>
                                <td style="font-size: 10px;">Extension 80</td>
                                <td><input style="width: 50px;" type="text" value="" name="wrist_extension_l_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="wrist_extension_r_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="wrist_extension_l_2"></td>
                                <td><input style="width: 50px;" type="text" value="" name="wrist_extension_r_2"></td>
                            </tr>
                            <tr>
                                <td style="font-size: 10px;">Abduction 20</td>
                                <td><input style="width: 50px;" type="text" value="" name="wrist_abduction_l_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="wrist_abduction_r_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="wrist_abduction_l_2"></td>
                                <td><input style="width: 50px;" type="text" value="" name="wrist_abduction_r_2"></td>
                            </tr>
                            <tr>
                                <td style="font-size: 10px;">Adduction 35</td>
                                <td><input style="width: 50px;" type="text" value="" name="wrist_adduction_l_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="wrist_adduction_r_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="wrist_adduction_l_2"></td>
                                <td><input style="width: 50px;" type="text" value="" name="wrist_adduction_r_2"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input style="width: 50px;" type="text" value="" name="finger_thumb_opposition_l_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="finger_thumb_opposition_r_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="finger_thumb_opposition_l_2"></td>
                                <td><input style="width: 50px;" type="text" value="" name="finger_thumb_opposition_r_2"></td>
                            </tr>
                            <tr>
                                <td style="font-size: 10px;">MP Flexion 90</td>
                                <td><input style="width: 50px;" type="text" value="" name="finger_mp_flexion_l_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="finger_mp_flexion_r_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="finger_mp_flexion_l_2"></td>
                                <td><input style="width: 50px;" type="text" value="" name="finger_mp_flexion_r_2"></td>
                            </tr>
                            <tr>
                                <td style="font-size: 10px;">MP Extension 40</td>
                                <td><input style="width: 50px;" type="text" value="" name="finger_mp_extension_l_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="finger_mp_extension_r_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="finger_mp_extension_l_2"></td>
                                <td><input style="width: 50px;" type="text" value="" name="finger_mp_extension_r_2"></td>
                            </tr>
                            <tr>
                                <td style="font-size: 10px;">IP Flexion 120</td>
                                <td><input style="width: 50px;" type="text" value="" name="finger_ip_flexion_l_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="finger_ip_flexion_r_1"></td>
                                <td><input style="width: 50px;" type="text" value="" name="finger_ip_flexion_l_2"></td>
                                <td><input style="width: 50px;" type="text" value="" name="finger_ip_flexion_r_2"></td>
                            </tr>
                        </tbody>
                    </table>
                    <br><br>
                    <label for="Remarks5">Remarks:</label><br>
                    <textarea name="remarks" id="Remarks5" cols="40" rows="6"></textarea>
                </div>
            </div>
            </div>
            <div class="border size-fit p-fit">
                <div style="display: flex; gap: .5rem;">
                    ...
                    <div>
                            ...
                            <tbody>
                                <tr style="height: 60px; width: 100%;">
                                    ...
                                    <th rowspan="1" class="t-center" colspan="4">RT<input
                                            style="border: 1px solid rgb(10, 226, 10); width: 100%;" type="text" value="" name="lower_limb_rt">
                                    </th>
                                    <th rowspan="1" class="t-center" colspan="4">LT <input
                                            style="border: 1px solid rgb(10, 226, 10); width: 55%;" type="text" value="" name="lower_limb_lt">
                                    </th>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <span class="mt-3"> Neck:
                            <input type="text" value="" name="neck_span">
                        </span>
                    </div>
                    <div>
                        <table style="" class="RangeOfMotionTable" border="1">
                            <tbody>
                                <table style="width: 100%; font-size: 12px;" class="RangeOfMotionTable" border="1">
                                    <tbody class="mb-4">
                                        <tr style="height: 60px; width: 100%;">
                                            ...
                                            <th rowspan="1" class="t-center" colspan="4">RT<input
                                                    style="border: 1px solid rgb(10, 226, 10); width: 100%;" type="text" value="" name="upper_limb_rt">
                                            </th>
                                            <th rowspan="1" class="t-center" colspan="4">LT <input
                                                    style="border: 1px solid rgb(10, 226, 10); width: 100%;" type="text" value="" name="upper_limb_lt">
                                            </th>
                                        </tr>
                                    </tbody>
                                </table>
                                <br />
                                <span> Trunk:
                                    <input class="mt-3" type="text" value="" name="trunk_span">
                                </span>
                    </div>
                </div>
            </div>
            <div class="border size-fit p-fit">
                <div style="display: flex; gap: .5rem;">
                    <div style="width: 295px; display: flex;">
                        ...
                        <p style="font-size: 13px;">
                            <input type="checkbox" value='1' name="hypertonia" id="hypertonia">
                            Hypertonia

                            <input type="checkbox" value='1' name="hypotonia" id="hypotonia">
                            Hypotonia
                        </p>
                    </div>
                </div>
                        ...
                        <table class="RangeOfMotionTable" border="1">
                            <tbody>
                                <tr>
                                    ...
                                    <th class="t-center"><input class="keda" type="checkbox" value="1" name="static_sitting_normal"> Normal</th>
                                </tr>
                                <tr>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1" name="static_sitting_good"> Good</th>
                                </tr>
                                <tr>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1" name="static_sitting_poor"> Poor</th>
                                </tr>
                                <tr>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1" name="static_sitting_not_possible"> Not Possible</th>
                                </tr>
                                <tr>
                                    <th class="t-center" rowspan="4">Standing Static</th>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1" name="static_standing_normal"> Normal</th>
                                </tr>
                                <tr>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1" name="static_standing_good"> Good</th>
                                </tr>
                                <tr>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1" name="static_standing_poor"> Poor</th>
                                </tr>
                                <tr>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1" name="sstatic_tanding_not_possible"> Not Possible</th>
                                </tr>

                                <tr>
                                    <th class="t-center" rowspan="4">Dynamic Static</th>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1" name="dynamic_sitting_normal"> Normal</th>
                                </tr>
                                <tr>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1" name="dynamic_sitting_good"> Good</th>
                                </tr>
                                <tr>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1" name="dynamic_sitting_poor"> Poor</th>
                                </tr>
                                <tr>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1" name="dynamic_sitting_not_possible"> Not Possible</th>
                                </tr>
                                <tr>
                                    <th class="t-center" rowspan="4">Dynamic Static</th>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1" name="dynamic_standing_normal"> Normal</th>
                                </tr>
                                <tr>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1" name="dynamic_standing_good"> Good</th>
                                </tr>
                                <tr>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1" name="dynamic_standing_poor"> Poor</th>
                                </tr>
                                <tr>
                                    <th class="t-center"><input class="keda" type="checkbox" value="1" name="dynamic_standing_not_possible"> Not Possible</th>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <table class="RangeOfMotionTable" border="1">
                            <tbody>
                                <tr>
                                    ...
                                    <th colspan="2" class="t-center"><input class="keda" type="checkbox" value="1" name="upper_limbs_good"> Good</th>
                                    <th colspan="2" class="t-center"><input class="keda" type="checkbox" value="1" name="upper_limbs_poor"> Poor</th>
                                    <th colspan="2" class="t-center"><input class="keda" type="checkbox" value="1" name="upper_limbs_not_possible"> Not Possible</th>
                                </tr>
                                <tr>
                                    <th>L</th>
                                    <th>R</th>
                                ...
                                <tr>
                                    ...
                                    <th colspan="2" class="t-center"><input class="keda" type="checkbox" value="1" name="lower_limbs_good"> Good</th>
                                    <th colspan="2" class="t-center"><input class="keda" type="checkbox" value="1" name="lower_limbs_poor"> Poor</th>
                                    <th colspan="2" class="t-center"><input class="keda" type="checkbox" value="1" name="lower_limbs_not_possible"> Not Possible</th>
                                </tr>
                                <tr>
                                    <th>L</th>
                                    <th>R</th>
                                ...
                                <tr>
                                    ...
                                    <td colspan="6">
                                        <textarea value='' name="coordination_comments" cols="30" rows="3">   </textarea>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <table style="font-size: 10px;">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="text" value='' name="i0"></td>
                            <th>Crawling</th>
                            <td class="t-center"><input type="checkbox" value="1" name="i1"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i2"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i3"></td>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;"></th>
                            <td><input type="text" value='' name="i4"></td>
                            <th>Crouching gait</th>
                            <td class="t-center"><input type="checkbox" value="1" name="i5"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i6"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i7"></td>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;"></th>
                            <td><input type="text" value='' name="i8"></td>
                            <th>Walking</th>
                            <td class="t-center"><input type="checkbox" value="1" name="i9"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i10"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i11"></td>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;"></th>
                            <td><input type="text" value='   ' name="i12"></td>
                            <th>Squatting</th>
                            <td class="t-center"><input type="checkbox" value="1" name="i13"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i14"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i15"></td>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;"></th>
                            <td><input type="text" value='   ' name="i17"></td>
                            <th>Stairs</th>
                            <td class="t-center"><input type="checkbox" value="1" name="i18"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i19"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i20"></td>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;"></th>
                            <td><input type="text" value='' name="i21"></td>
                            <th>Running</th>
                            <td class="t-center"><input type="checkbox" value="1" name="i22"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i23"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i24"></td>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;">TRANSFERS</th>
                            <td><input type="text" value='' name="i25"></td>
                            <th>Lie to Sit (opposite)</th>
                            <td class="t-center"><input type="checkbox" value="1" name="i26"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i27"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i28"></td>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;"></th>
                            <td><input type="text" value='' name="i29"></td>
                            <th>Sit to Stand (opposite)</th>
                            <td class="t-center"><input type="checkbox" value="1" name="i30"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i31"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i32"></td>
                            <td></td>
                        </tr>
                        <th style="border: none;"></th>
                        <td><input type="text" value='' name="i16"></td>
                        <th>Stand to Floor (opposite)</th>
                        <td class="t-center"><input type="checkbox" value="1" name="i33"></td>
                        <td class="t-center"><input type="checkbox" value="1" name="i34"></td>
                        <td class="t-center"><input type="checkbox" value="1" name="i35"></td>
                        <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;"></th>
                            <td><input type="text" value='' name="i36"></td>
                            <th>Sit to sit</th>
                            <td class="t-center"><input type="checkbox" value="1" name="i37"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i38"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i39"></td>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;">BALANCE</th>
                            <td><input type="text" value='' name="i40"></td>
                            <th>Sitting</th>
                            <td class="t-center"><input type="checkbox" value="1" name="i41"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i42"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i43"></td>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;"></th>
                            <td><input type="text" value='' name="i44"></td>
                            <th>Standing</th>
                            <td class="t-center"><input type="checkbox" value="1" name="i45"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i46"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i47"></td>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;"></th>
                            <td><input type="text" value='' name="i48"></td>
                            <th>On one leg</th>
                            <td class="t-center"><input type="checkbox" value="1" name="i49"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i50"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i51"></td>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;">UPPER LIMB</th>
                            <td><input type="text" value='' name="i52"></td>
                            <th rowspan="2">
                            ...
                            <td class="t-center"><input type="checkbox" value="1" name="i53"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i54"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i55"></td>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;">FUNCTIO</th>
                            <td><input type="text" value='   ' name="i56"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i57"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i58"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i59"></td>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;"></th>
                            <td><input type="text" value='   ' name="i60"></td>
                            <th rowspan="2">
                                <div style="justify-content: space-between; position: relative;" class="flex">
                                    <div>Release </div>
                                    <div
                            ...
                            <td class="t-center"><input type="checkbox" value="1" name="i61"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i62"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i63"></td>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;"></th>
                            <td><input type="text" value='   ' name="i64"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i65"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i66"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i67"></td>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;"></th>
                            <td><input type="text" value='' name="i68"></td>
                            <th rowspan="2">
                                <div style="justify-content: space-between; position: relative;" class="flex">
                            ...
                            <td class="t-center"><input type="checkbox" value="1" name="i69"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i70"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i71"></td>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;"></th>
                            <td><input type="text" value='   ' name="i72"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i73"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i74"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i75"></td>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;"></th>
                            <td><input type="text" value='   ' name="i76"></td>
                            <th rowspan="2">
                                <div style="justify-content: space-between; position: relative;" class="flex">
                                    <div>Holding </div>
                                    <div
                            ...
                            <td class="t-center"><input type="checkbox" value="1" name="i77"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i78"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i79"></td>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;"></th>
                            <td><input type="text" value='   ' name="i80"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i81"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i82"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i83"></td>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;"></th>
                            <td><input type="text" value='   ' name="i84"></td>
                            <th rowspan="2">
                                <div style="justify-content: space-between; position: relative;" class="flex">
                                    <div><input type="text" value='   ' name="i85" style="width: 50%"></div>
                                    <div
                            ...
                            <td class="t-center"><input type="checkbox" value="1" name="i86"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i87"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i88"></td>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;"></th>
                            <td><input type="text" value='   ' name="i89"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i90"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i91"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i92"></td>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;">DAILY LIFE</th>
                            <td><input type="text" value='   ' name="i93"></td>
                            <th>Dressing - Upper body</th>
                            <td class="t-center"><input type="checkbox" value="1" name="i94"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i95"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i96"></td>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;">ACTIVITIES</th>
                            <td><input type="text" value='   ' name="i97"></td>
                            <th>Dressing - Lower Body</th>
                            <td class="t-center"><input type="checkbox" value="1" name="i98"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i99"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i100"></td>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;"></th>
                            <td><input type="text" value='   ' name="i101"></td>
                            <th>Toileting</th>
                            <td class="t-center"><input type="checkbox" value="1" name="i102"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i103"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i104"></td>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;"></th>
                            <td><input type="text" value='   ' name="i105"></td>
                            <th>Bathing</th>
                            <td class="t-center"><input type="checkbox" value="1" name="i106"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i107"></td>
                            <td class="t-center"><input type="checkbox" value="1" name="i108"></td>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;"></th>
                            <td><input type="text" value='   ' name="i109"></td>

                            <th style="border: none;">ASSISTED </th>
                            <td><input type="text" value='   ' name="i110"></td>
                            <th>Without assisted devices</th>
                            <td class="t-center"><input type="checkbox" value="1" name="i111"></td>
                            <th class="t-center"><input class="keda" type="checkbox" value="1" name="i112">&nbsp;Good</th>
                            <th class="t-center"><input class="keda" type="checkbox" value="1" name="i113">&nbsp;Bad</th>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;">DEVICES </th>
                            <td><input type="text" value='   ' name="i114"></td>
                            <th>One crutch</th>
                            <td class="t-center"><input type="checkbox" value="1" name="i115"></td>
                            <th class="t-center"><input class="keda" type="checkbox" value="1" name="i116">&nbsp;Good</th>
                            <th class="t-center"><input class="keda" type="checkbox" value="1" name="i117">&nbsp;Bad</th>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;"> </th>
                            <td><input type="text" value='   ' name="i118"></td>
                            <th>Pair of crutches</th>
                            <td class="t-center"><input type="checkbox" value="1" name="i119"></td>
                            <th class="t-center"><input class="keda" type="checkbox" value="1" name="i120">&nbsp;Good</th>
                            <th class="t-center"><input class="keda" type="checkbox" value="1" name="i121">&nbsp;Bad</th>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;"> </th>
                            <td><input type="text" value='' name="i122"></td>
                            <th>Walking frame</th>
                            <td class="t-center"><input type="checkbox" value="1" name="i123"></td>
                            <th class="t-center"><input class="keda" type="checkbox" value="1" name="i124">&nbsp;Good</th>
                            <th class="t-center"><input class="keda" type="checkbox" value="1" name="i125">&nbsp;Bad</th>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;"> </th>
                            <td><input type="text" value='   ' name="i126"></td>
                            <th>Wheelchair</th>
                            <td class="t-center"><input type="checkbox" value="1" name="i127"></td>
                            <th class="t-center"><input class="keda" type="checkbox" value="1" name="i128">&nbsp;Good</th>
                            <th class="t-center"><input class="keda" type="checkbox" value="1" name="i129">&nbsp;Bad</th>
                            <td></td>
                        </tr>
                        <tr>
                            <th style="border: none;"> </th>
                            <td><input type="text" value='   ' name="i130"></td>
                            <th>Orthoses right side</th>
                            <td class="t-center"><input type="checkbox" value="1" name="i131"></td>
                            <th class="t-center"><input class="keda" type="checkbox" value="1" name="i132">&nbsp;Good</th>
                            <th class="t-center"><input class="keda" type="checkbox" value="1" name="i133">&nbsp;Bad</th>
                            <th>
                                <input class="keda" type="checkbox" value="1" name="i134" id="">&nbsp;FO
                                <input class="keda" type="checkbox" value="1" name="i135" id="">&nbsp;AFO
                                <input class="keda" type="checkbox" value="1" name="i136" id="">&nbsp;KAFO
                                <input class="keda" type="checkbox" value="1" name="i137" id="">&nbsp;HKAFO
                                <input class="keda" type="checkbox" value="1" name="i138" id="">&nbsp;Shoe raise
                            </th>
                        </tr>
                        <tr>
                            <th style="border: none;"> </th>
                            <td><input type="text" value='   ' name="i139"></td>
                            <th>Orthosis left side</th>
                            <td class="t-center"><input type="checkbox" value="1" name="i140"></td>
                            <th class="t-center"><input class="keda" type="checkbox" value="1" name="i141">&nbsp;Good</th>
                            <th class="t-center"><input class="keda" type="checkbox" value="1" name="i142">&nbsp;Bad</th>
                            <th>
                                <input class="keda" type="checkbox" value="1" name="i143" id="">&nbsp;FO
                                <input class="keda" type="checkbox" value="1" name="i144" id="">&nbsp;AFO
                                <input class="keda" type="checkbox" value="1" name="i145" id="">&nbsp;KAFO
                                <input class="keda" type="checkbox" value="1" name="i146" id="">&nbsp;HKAFO
                                <input class="keda" type="checkbox" value="1" name="i147" id="">&nbsp;Shoe raise
                            </th>
                        </tr>
            ...
            <script>
                ...
                function addProblem2() {
                    const list = document.getElementById('problems-list2'); // Correct ID for section 2
                    const newItem = document.createElement('li');
                ...
                function addShortTermGoal2() {
                    const list = document.getElementById('short-term-goals2'); // Correct ID for section 2
                    const newItem = document.createElement('li');
                ...
                function addLongTermGoal2() {
                    const list = document.getElementById('long-term-goals2'); // Correct ID for section 2
                    const newItem = document.createElement('li');
                ...
                function addProblem3() {
                    const list = document.getElementById('problems-list3'); // Correct ID for section 3
                    const newItem = document.createElement('li');
                ...
                function addShortTermGoal3() {
                    const list = document.getElementById('short-term-goals3'); // Correct ID for section 3
                    const newItem = document.createElement('li');
                ...
                function addLongTermGoal3() {
                    const list = document.getElementById('long-term-goals3'); // Correct ID for section 3
                    const newItem = document.createElement('li');
