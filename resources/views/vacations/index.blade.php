...
<div class="container">
    ...
    <a href="{{ route('vacations.create') }}" class="add-vacation">
        اضافة طلب إجازة جديد
    </a>
    ...
    <table class="table mt-5 table-striped w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                <td class="px-6 py-4">{{ $vacation->id }}</td>
                <td class="px-6 py-4">{{ $vacation->start_date }}</td>
                <td class="px-6 py-4">{{ $vacation->end_date }}</td>
                <td class="px-6 py-4">
                    <span class="badge 
